...
class AirLogixSimEnvVisualizer():
    def __init__(self, mode:str='graphic', config:dict=None, env=None):
        """The visualizer for AirLogixSimEnv. It provides the visualization of the environment. Agent interacts with this class to get the visualized state, reward, and done signal.
    ...
    def render(self, env):
        ...
        Args:
            env (AirLogixSimEnv): The environment.
        """
        self._layout.render()